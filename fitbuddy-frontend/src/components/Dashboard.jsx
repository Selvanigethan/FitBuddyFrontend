              ...
              <div className="d-flex align-items-end row">
                <div className="col-sm-6">
                  <div className="card-body">
                    <h5 className="card-title text-primary">Welome to FITBuddy Gym App 🎉</h5>
                    <p className="mb-4">
                    Consistency is what transforms average into excellence.<span className="fw-bold"> So, Lets get Started!</span> 
                    </p>
                ...
                <div className="col-sm-6 text-center text-sm-left">
                  <div className="card-body pb-0 px-0 px-md-4">
                    <div className='row'>
                      ...
                      style={{ width: '160px', height: '200px', marginBottom: '0px' }}
                      alt="View Badge User"
                      data-app-dark-img="gym.png"
                      data-app-light-img="gym.png"
                    />
                       </div>
                       <div className='col-sm-6'>
                       <img
              ...
              <div className="col-lg-6 col-md-12 col-6 mb-4">
                <div className="card">
                  <div className="card-body">
                    ...
                    <span className="fw-semibold d-block mb-1">Fat Percentage</span>
              ...
              <div className="col-lg-6 col-md-12 col-6 mb-4">
                <div className="card">
                  <div className="card-body">
                    ...
                    <span>Calories</span>
                    <h3 className="card-title text-nowrap mb-1">kcal</h3>
                    <small className="text-success fw-semibold"><i className="bx bx-up-arrow-alt"></i>kcal</small>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="row row-bordered g-0">
                <div className="col-md-8">
                  <h5 className="card-header m-0 me-2 pb-3"></h5>
                ...
                <div className="col-md-4">
                  ...
                  <div className="text-center fw-semibold pt-3 mb-2"></div>
              ...
              <div className="col-6 mb-4">
                <div className="card">
                  <div className="card-body">
                    ...
                    <span className="d-block mb-1">Why Diet?</span>
                    <h3 className="card-title text-nowrap mb-2"></h3>
              ...
              <div className="col-6 mb-4">
                <div className="card">
                  <div className="card-body">
                    ...
                    <span className="fw-semibold d-block mb-1">Why workout?</span>
                    <h3 className="card-title mb-2"></h3>
                    <small className="text-success fw-semibold"><i className="bx bx-up-arrow-alt"></i></small>
                  </div>
                </div>
                    ...
                    <div className="d-flex justify-content-between flex-sm-row flex-column gap-3">
                      <div className="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                        <div className="card-title">
                          <h5 className="text-nowrap mb-2"></h5>
                        ...
                        <div className="mt-sm-auto">
                          <small className="text-success text-nowrap fw-semibold"
                            ><i className="bx bx-chevron-up"></i></small
                          >
